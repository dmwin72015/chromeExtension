...
/*
 * 控制设置cookie, 图片,位置JavaScript,插件的等功能的设置
 * 可以设置的类型(type)
 * cookies images javascript location plugins  popups notifications fullscreen mouselock microphone camera unsandboxedPlugins automaticDownloads
 * */
...
document.addEventListener('DOMContentLoaded', function () {
  chrome.tabs.query({active: true, currentWindow: true}, function (tabs) {
    var current = tabs[0];
    incognito = current.incognito;//是否是隐身模式
    url = current.url;
